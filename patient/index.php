            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-pds">
                        <a href="/gfi-guidance-final1/pds/pds.php" class="non-style-link-menu"><div><p class="menu-text">My PDS</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about doctors? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Counselor"</b></a> section or 
                            ...
                            <form action="schedule.php" method="post" style="display: flex">
                                ...
                                <input type="search" name="search" class="input-text " placeholder="Search Counselor and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
