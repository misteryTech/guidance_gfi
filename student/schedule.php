             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-pds">
                        <a href="pds_page.php" class="non-style-link-menu"><div><p class="menu-text">My PDS</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Counselor name or Email or Date (YYYY-MM-DD)" list="Counselors" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
