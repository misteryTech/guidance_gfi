            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-doctor-active">
                        <a href="counselor.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">All Counselor</p></a></div>
                    </td>
                </tr>
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <?php
                                ...
                                $list11 = $database->query("select  couname,couemail from  counselor;");
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>Redirect to counselor sessions?</h2>
                        <a class="close" href="counselor.php">&times;</a>
                        <div class="content">
