...
<head>
    ...
    <style>
        .dashbord-tables,.counselor-header{
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    <td colspan="4">
                        <center>
                            <table class="filter-container counselor-header" style="border: none;width:95%" border="0">
                                <tr>
                                    <td>
                                        <h3>Welcome!</h3>
                                        <h1><?php echo $username ?>.</h1>
                                        <p>Thanks for joining us. You can view your daily schedule, manage student appointments, and more!<br><br></p>
                    ...
                    <td colspan="4">
                        <table border="0" width="100%">
                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%;">
                                                    <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        ...
                                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/session-icecream.svg');"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <td>
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;">Your Upcoming Sessions until Next Week</p>
                                    <center>
                                                ...
                                                <tbody>
                                                    ...
                                                    if($result->num_rows==0){
                                                        ...
                                                        for ( $x=0; $x<$result->num_rows;$x++){
                                                            ...
                                                            $scheduleid=$row["student_id"];
                                                            $title=$row["counselor_id"];
                                                            $apponum=$row["appointment_date"];
                                                            $reason=$row["reason"];
                                          
                                                            echo '<tr>
                                                                <td style="padding:20px;"> &nbsp;'.
                                                                substr($scheduleid,0,20)
                                                                .'</td>
                                                                <td style="padding:20px;font-size:13px;">
                                                                    '.substr($reason,0,30).'
                                                                </td>
                                                                <td style="text-align:center;">
                                                                    '.substr($apponum,0,10).' '.substr($apponum,0,5).'
                                                                </td>
                                                            </tr>';
                                                        }
                                                    }
