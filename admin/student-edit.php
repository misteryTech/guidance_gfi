...
if ($_POST) {
    ...
    if ($password === $cpassword) {
        ...
        $result = $database->query("SELECT student.pid FROM student INNER JOIN webuser ON student.pid = webuser.email WHERE webuser.email = '$email';");
        ...
        if ($id2 != $id) {
            ...
            $sql1 = "UPDATE student SET pemail='$email', pname='$name', pnic='$nic', ptel='$tele'";
